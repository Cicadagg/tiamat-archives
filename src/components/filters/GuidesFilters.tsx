...
import "./Filters.css";
import { GuidesFiltersList } from "./filters-list/GuidesFiltersList";
import { clearTags } from "../../store/reducers/guides-tags-reducer";

type TFilterVisibility = "hide" | "show";

export const GuidesFilters:React.FC = () => {
    ...
    return (
        <section className={"filters"}>
            <header className={`filters-main-header ${filterVisibility === "hide" ? "filters-main-header--collapse" : ""}`}>
                ...
                <button onClick={()=>clearFilters()} className="clear-filters btn-filters"><ClearFilterSVG/>{t("Filters.clearFilters")} </button>
